...
- `../../author-persona.md`
- `../../PoissonPartitionFunctionSolution.md`

- Candidate solution: `../../PoissonPartitionFunctionSolution.md`
...
Evaluate whether `PoissonPartitionFunctionSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../PoissonPartitionFunctionSolution.md",
  "candidate_path": "PoissonPartitionFunctionSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
