...
- `../../author-persona.md`
- `../../OrbitQuotientFactorialSolution.md`

- Candidate solution: `../../OrbitQuotientFactorialSolution.md`

Task:

Evaluate whether `OrbitQuotientFactorialSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../OrbitQuotientFactorialSolution.md",
  "candidate_path": "OrbitQuotientFactorialSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
