...
- `../../author-persona.md`
- `../../KoszulSimplexResolutionSolution.md`

- Candidate solution: `../../KoszulSimplexResolutionSolution.md`

Task:

Evaluate whether `KoszulSimplexResolutionSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../KoszulSimplexResolutionSolution.md",
  "candidate_path": "KoszulSimplexResolutionSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
