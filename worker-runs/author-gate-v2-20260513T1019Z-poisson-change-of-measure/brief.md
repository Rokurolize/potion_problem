...
- `../../author-persona.md`
- `../../PoissonChangeOfMeasureSolution.md`
...
Evaluate whether `PoissonChangeOfMeasureSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_path": "PoissonChangeOfMeasureSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
