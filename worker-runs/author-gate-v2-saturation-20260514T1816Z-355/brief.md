...
- `../../author-persona.md`
- `../../Saturation355RenewalLiftingOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation355RenewalLiftingOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation355RenewalLiftingOrderPolytopeSolution.md` would make the author-persona v2 naturally say
