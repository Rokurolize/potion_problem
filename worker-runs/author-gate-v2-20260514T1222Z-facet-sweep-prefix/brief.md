...
- `../../author-persona.md`
- `../../FacetSweepPrefixSolution.md`

- Candidate solution: `../../FacetSweepPrefixSolution.md`

Task:

Evaluate whether `FacetSweepPrefixSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../FacetSweepPrefixSolution.md",
  "candidate_path": "FacetSweepPrefixSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
