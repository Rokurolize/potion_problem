...
- `../../author-persona.md`
- `../../Saturation733RenewalConditioningOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation733RenewalConditioningOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation733RenewalConditioningOrderPolytopeSolution.md` would make the author-persona v2 naturally say
