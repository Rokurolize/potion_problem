...
You are an independent evaluator for a single candidate solution. Keep the evaluation concise and write `result.json` promptly after reading the inputs.

Read:

- `../../author-persona.md`
- `../../OrderPolytopeLinearExtensionSolution.md`

- Candidate solution: `../../OrderPolytopeLinearExtensionSolution.md`
...
Evaluate whether `OrderPolytopeLinearExtensionSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../OrderPolytopeLinearExtensionSolution.md",
  "candidate_path": "OrderPolytopeLinearExtensionSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
