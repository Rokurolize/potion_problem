...
- `../../author-persona.md`
- `../../HarmonicPotentialCertificateSolution.md`

- Candidate solution: `../../HarmonicPotentialCertificateSolution.md`

Task:

Evaluate whether `HarmonicPotentialCertificateSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../HarmonicPotentialCertificateSolution.md",
  "candidate_path": "HarmonicPotentialCertificateSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
