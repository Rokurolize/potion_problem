...
- `../../author-persona.md`
- `../../PoissonArrivalInverseSolution.md`

- Candidate solution: `../../PoissonArrivalInverseSolution.md`
...
Evaluate whether `PoissonArrivalInverseSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../PoissonArrivalInverseSolution.md",
  "candidate_path": "PoissonArrivalInverseSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
