...
- `../../author-persona.md`
- `../../AbsorbingFundamentalMatrixSolution.md`

- Candidate solution: `../../AbsorbingFundamentalMatrixSolution.md`

Task:

Evaluate whether `AbsorbingFundamentalMatrixSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../AbsorbingFundamentalMatrixSolution.md",
  "candidate_path": "AbsorbingFundamentalMatrixSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
