...
- `../../author-persona.md`
- `../../Saturation247RenewalLocalizationOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation247RenewalLocalizationOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation247RenewalLocalizationOrderPolytopeSolution.md` would make the author-persona v2 naturally say
