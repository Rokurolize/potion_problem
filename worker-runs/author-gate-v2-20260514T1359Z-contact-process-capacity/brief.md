...
- `../../author-persona.md`
- `../../ContactProcessCapacitySolution.md`

- Candidate solution: `../../ContactProcessCapacitySolution.md`

Task:

Evaluate whether `ContactProcessCapacitySolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ContactProcessCapacitySolution.md",
  "candidate_path": "ContactProcessCapacitySolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
