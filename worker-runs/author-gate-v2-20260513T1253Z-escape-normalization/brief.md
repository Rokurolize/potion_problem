...
- `../../author-persona.md`
- `../../EscapeNormalizationSolution.md`

- Candidate solution: `../../EscapeNormalizationSolution.md`
...
Evaluate whether `EscapeNormalizationSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../EscapeNormalizationSolution.md",
  "candidate_path": "EscapeNormalizationSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
