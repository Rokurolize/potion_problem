...
- `../../author-persona.md`
- `../../Saturation760RenewalCalibrationOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation760RenewalCalibrationOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation760RenewalCalibrationOrderPolytopeSolution.md` would make the author-persona v2 naturally say
