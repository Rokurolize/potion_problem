...
- `../../author-persona.md`
- `../../Saturation367RenewalLiftingSurvivalFunctionSolution.md`

- Candidate solution: `../../Saturation367RenewalLiftingSurvivalFunctionSolution.md`

Task:

Evaluate whether `Saturation367RenewalLiftingSurvivalFunctionSolution.md` would make the author-persona v2 naturally say
