...
- `../../author-persona.md`
- `../../ResidueCoefficientSolution.md`

- Candidate solution: `../../ResidueCoefficientSolution.md`
...
Evaluate whether `ResidueCoefficientSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ResidueCoefficientSolution.md",
  "candidate_path": "ResidueCoefficientSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
