...
- `../../author-persona.md`
- `../../ResidualFractionCascadeSolution.md`

- Candidate solution: `../../ResidualFractionCascadeSolution.md`
...
Evaluate whether `ResidualFractionCascadeSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ResidualFractionCascadeSolution.md",
  "candidate_path": "ResidualFractionCascadeSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
