...
- `../../author-persona.md`
- `../../TerminalJumpNormalizationSolution.md`

- Candidate solution: `../../TerminalJumpNormalizationSolution.md`
...
Evaluate whether `TerminalJumpNormalizationSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../TerminalJumpNormalizationSolution.md",
  "candidate_path": "TerminalJumpNormalizationSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
