...
- `../../author-persona.md`
- `../../Saturation220RenewalInterpolationOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation220RenewalInterpolationOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation220RenewalInterpolationOrderPolytopeSolution.md` would make the author-persona v2 naturally say
