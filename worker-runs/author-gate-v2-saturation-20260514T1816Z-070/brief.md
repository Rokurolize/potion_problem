...
- `../../author-persona.md`
- `../../Saturation070RenewalNormalizationSurvivalFunctionSolution.md`

- Candidate solution: `../../Saturation070RenewalNormalizationSurvivalFunctionSolution.md`

Task:

Evaluate whether `Saturation070RenewalNormalizationSurvivalFunctionSolution.md` would make the author-persona v2 naturally say
