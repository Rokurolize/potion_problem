...
- `../../author-persona.md`
- `../../CumulativeCapacityRewardSolution.md`

- Candidate solution: `../../CumulativeCapacityRewardSolution.md`
...
Evaluate whether `CumulativeCapacityRewardSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../CumulativeCapacityRewardSolution.md",
  "candidate_path": "CumulativeCapacityRewardSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
