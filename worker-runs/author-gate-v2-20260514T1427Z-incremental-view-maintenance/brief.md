...
- `../../author-persona.md`
- `../../IncrementalViewMaintenanceSolution.md`

- Candidate solution: `../../IncrementalViewMaintenanceSolution.md`

Task:

Evaluate whether `IncrementalViewMaintenanceSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../IncrementalViewMaintenanceSolution.md",
  "candidate_path": "IncrementalViewMaintenanceSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
