...
- `../../author-persona.md`
- `../../QueueWorkloadPrefixSolution.md`

- Candidate solution: `../../QueueWorkloadPrefixSolution.md`

Task:

Evaluate whether `QueueWorkloadPrefixSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../QueueWorkloadPrefixSolution.md",
  "candidate_path": "QueueWorkloadPrefixSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
