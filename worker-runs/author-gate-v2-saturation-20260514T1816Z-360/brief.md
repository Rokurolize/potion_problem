...
- `../../author-persona.md`
- `../../Saturation360RenewalLiftingUnitThresholdSolution.md`

- Candidate solution: `../../Saturation360RenewalLiftingUnitThresholdSolution.md`

Task:

Evaluate whether `Saturation360RenewalLiftingUnitThresholdSolution.md` would make the author-persona v2 naturally say
