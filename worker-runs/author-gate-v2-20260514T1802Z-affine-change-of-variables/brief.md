...
- `../../author-persona.md`
- `../../AffineChangeOfVariablesSolution.md`

- Candidate solution: `../../AffineChangeOfVariablesSolution.md`

Task:

Evaluate whether `AffineChangeOfVariablesSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../AffineChangeOfVariablesSolution.md",
  "candidate_path": "AffineChangeOfVariablesSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
