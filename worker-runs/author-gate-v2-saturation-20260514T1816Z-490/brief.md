...
- `../../author-persona.md`
- `../../Saturation490RenewalShadowOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation490RenewalShadowOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation490RenewalShadowOrderPolytopeSolution.md` would make the author-persona v2 naturally say
