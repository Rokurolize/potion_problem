...
- `../../author-persona.md`
- `../../LeftInverseOperatorCertificateSolution.md`

- Candidate solution: `../../LeftInverseOperatorCertificateSolution.md`
...
Evaluate whether `LeftInverseOperatorCertificateSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../LeftInverseOperatorCertificateSolution.md",
  "candidate_path": "LeftInverseOperatorCertificateSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
