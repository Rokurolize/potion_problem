...
- `../../author-persona.md`
- `../../ConditionalExpectationTailSolution.md`

- Candidate solution: `../../ConditionalExpectationTailSolution.md`

Task:

Evaluate whether `ConditionalExpectationTailSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ConditionalExpectationTailSolution.md",
  "candidate_path": "ConditionalExpectationTailSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
