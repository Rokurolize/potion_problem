...
- `../../author-persona.md`
- `../../ExponentialRaceSurvivalSolution.md`

- Candidate solution: `../../ExponentialRaceSurvivalSolution.md`
...
Evaluate whether `ExponentialRaceSurvivalSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ExponentialRaceSurvivalSolution.md",
  "candidate_path": "ExponentialRaceSurvivalSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
