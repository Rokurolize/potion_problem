...
- `../../author-persona.md`
- `../../PoissonConfigurationMeasureSolution.md`
...
Evaluate whether `PoissonConfigurationMeasureSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_path": "PoissonConfigurationMeasureSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
