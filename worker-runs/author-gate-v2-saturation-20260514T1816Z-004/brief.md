...
- `../../author-persona.md`
- `../../Saturation004RenewalCertificateOrderPolytopeSolution.md`

- Candidate solution: `../../Saturation004RenewalCertificateOrderPolytopeSolution.md`

Task:

Evaluate whether `Saturation004RenewalCertificateOrderPolytopeSolution.md` would make the author-persona v2 naturally say
