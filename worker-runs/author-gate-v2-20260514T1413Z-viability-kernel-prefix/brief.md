...
- `../../author-persona.md`
- `../../ViabilityKernelPrefixSolution.md`

- Candidate solution: `../../ViabilityKernelPrefixSolution.md`

Task:

Evaluate whether `ViabilityKernelPrefixSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../ViabilityKernelPrefixSolution.md",
  "candidate_path": "ViabilityKernelPrefixSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
