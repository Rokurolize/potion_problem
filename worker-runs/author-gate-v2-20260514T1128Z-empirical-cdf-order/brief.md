...
- `../../author-persona.md`
- `../../EmpiricalCdfOrderSolution.md`

- Candidate solution: `../../EmpiricalCdfOrderSolution.md`

Task:

Evaluate whether `EmpiricalCdfOrderSolution.md` would make the author-persona v2 naturally say the exact target line:
...
```json
{
  "candidate_solution_path": "../../EmpiricalCdfOrderSolution.md",
  "candidate_path": "EmpiricalCdfOrderSolution.md",
  "persona_version": "v2",
  "gate": "pass or fail",
